...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "@〲РЇССНЇ 〆. ツMâLツ࿐ ") || (event.body.toLowerCase() == "লোগো দাও") || (event.body.toLowerCase() == "শান্ত কই") || (event.body.toLowerCase() == "শান্ত ")) {
     return api.sendMessage(" বস শান্ত উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন.আর কিছু বলার তাকলে অনার ইনবক্সে যান .!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ [ - ]➠𓆩𝐒𝐇𝐀𝐍𝐓𝐎'𝐒 𝐁𝐀𝐁𝐘᭄𓆪ـ ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 [ - ]➠𓆩𝐒𝐇𝐀𝐍𝐓𝐎.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/DK.TEAM.ER.C.E.O.OKY.UR.DAD"nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:[ - ]➠𓆩𝐒𝐇𝐀𝐍𝐓𝐎'𝐒 𝐁𝐀𝐁𝐘 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস শান্ত  আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝐃𝐊  𝐒𝐀𝐍𝐓𝐎  ッ❤️ তাকে সবাই পিচ্ছি শান্ত  নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami santo") || (event.body.toLowerCase() == "sala ami mafiya") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "মাগি😡")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   }
   if ((event.body.toLowerCase() == "@──♚♫ DAVIL MAFIYA ☄➝😈🩵🪽😈💛🪽😈💚🪽😈🩵🪽😈💛🪽😈 🩵🪽😈💛🪽😈💚🪽😈🩵🪽😈💛🪽😈") || (event.body.toLowerCase() == " মাফিয়া ")) {
     return api.sendMessage("আমার বস মাফিয়া কে কেমন মপনশন করো বুকা চোদা ওনি একন অফিসে আছে️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "@〲PICCI卝 বাইজিদツ࿐ ") || (event.body.toLowerCase() == "বাজিদ")) {
     return api.sendMessage("🥰-সিয়াম-🌺 আমার বস শান্ত 'র বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক এটা অনেক বড় মাগিবাজ😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hum")) {
     return api.sendMessage("️হুম চোদাইস না মাথা এমনিতেই গরম আছে বস শান্ত মারছে😭🤬⛏️😷", threadID);
   };

   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>আমার নাম আমার বস শান্ত কে জিগা😃", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "তরে চুদি") || (event.body.toLowerCase() == "tor nanire xudi")) {
   ...
   if ((event.body.toLowerCase() == "ami santo") || (event.body.toLowerCase() == "কিরে")) {
